...
public class RegistrationController {
  ...
  public ArrayList<RegistrationEntity> ReadRegistrations() {
    ...
    ArrayList<RegistrationEntity> read_registrations = registrationRepository.findAll();
  ...
  public ArrayList<RegistrationEntity> GetById(@PathVariable long id) {
    ...
    ArrayList<RegistrationEntity> read_registration = registrationRepository.findAllById(id);
